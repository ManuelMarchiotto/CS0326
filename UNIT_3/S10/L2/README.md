...
Esercizio di oggi: Gestione dei Permessi di Lettura, Scrittura ed Esecuzione in Linux 

Abbiamo visto come si gestiscono i permessi in Linux. Obiettivo: Configurare e gestire i permessi di lettura, scrittura ed esecuzione per file o directory in un 
sistema Linux. La scelta dei file o delle directory da configurare spetta allo studente. Infine, lo studente dovrà creare degli screenshot che mostrino i 
passaggi effettuati e scrivere una relazione spiegando le scelte fatte riguardo ai permessi.
